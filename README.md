...
| `composer vaults:open` | `vaults open` | Open the Vaults dashboard in your browser |
| `composer vaults:private:link` | `vaults private:link` | Create a key for this machine, wire private installs, and offer a public mirror too; `--global`, `--expires`, `--name`, `--with-public`, `--no-public` |
...
| `composer vaults:repositories` | `vaults repositories` | Third-party private Composer repositories the team has given Vaults credentials for |
